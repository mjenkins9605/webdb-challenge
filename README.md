...
A. RDBMS is a system to manage relational databases.  SQL is a query language used to retrieve data from a relational database.

2. Why do tables need a `primary key`?

A. Primary keys help to identify a specific entry.
